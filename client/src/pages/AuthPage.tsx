...
import { Loader2, Eye, EyeOff, TrendingUp, Shield, Zap, ArrowLeft } from "lucide-react";
            ...
            <Card className="p-8 rounded-3xl border-border/50 shadow-xl">
              {forgotSent ? (
                <div className="text-center">
                  ...
                  <h2 className="text-2xl font-display font-bold text-foreground mb-2" data-testid="text-forgot-sent">Email enviado!</h2>
                  <p className="text-muted-foreground mb-6">
                    Se existe uma conta com esse email, você receberá um link para redefinir sua senha. Verifique sua caixa de entrada e spam.
                  </p>
                  <Button
                ...
                <>
                  ...
                  <h2 className="text-2xl font-display font-bold text-foreground mb-2" data-testid="text-forgot-title">
                    Esqueceu sua senha?
                  </h2>
                  <p className="text-muted-foreground mb-6">
